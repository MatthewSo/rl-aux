...
for index in range(total_epoch):
    ...
    for i in range(train_batch):
        ...
        train_pred3, aux_weight = LabelGenerator(train_data, train_label[:, 2])  # generate auxiliary labels
    ...
    for i in range(train_batch):
        ...
        train_pred1, train_pred2 = VGG16_model(train_data)
        train_pred3, aux_weight = LabelGenerator(train_data, train_label[:, 2])
