...
def train_wamal_network(device, dataloader_train, dataloader_test, total_epoch, train_batch, test_batch, batch_size, model, label_network, optimizer, scheduler, gen_optimizer, gen_scheduler, num_axuiliary_classes, num_primary_classes, save_path, use_learned_weights, model_lr):
    ...
    for index in range(total_epoch):
        ...
        for i in range(train_batch):
            ...
            train_loss1 = model_fit(train_pred1, train_label, pri=True, num_output=num_primary_classes)
            train_loss2 = model_fit(train_pred2, train_pred3, pri=False, num_output=num_axuiliary_classes)
        ...
        with torch.no_grad():
            ...
            for i in range(test_batch):
                ...
                test_loss1 = model_fit(test_pred1, test_label, pri=True, num_output=num_primary_classes)
